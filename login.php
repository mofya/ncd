    ...
    <form class="form-horizontal" action="?" method="post">
        <div class="well col-md-7 col-md-offset-2">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <input type="text" class="form-control" placeholder="peter.ndebi" name="name" class="input-large">
              </div>
            </div>
            ...
            <div class='form-group'>
              ...
              <div class='col-md-4'>
                <input type='password' class="form-control" placeholder='type your password' name='password' class='input-large'>
