      ...
      if((strpos($k, "can") !== FALSE)) {
        $show_can_options .= "    
          <div class='form-group col-md-7'>
            <label class='control-label col-md-3' for='$safe_name'>".$options->prettyPrint(str_ireplace("can", "can ", $safe_name))."</label>
            <div class='col-md-6'>
...
echo "
    <div class='form-group col-md-7'>
      <label class='control-label col-md-3' for='priority'>Priority</label>
      <div class='col-md-6'>
  ...
  echo "
    <form class='form-horizontal' action='#' method='post'>
      ...
      <div class='form-group col-md-7'>
        <label class='control-label col-md-3' for='replace'>Replace group with: </label>
        <div class='col-md-6'>
